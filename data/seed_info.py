...
book_sub_title = (
    "주식과 부동산의 위기를 기회로 바꾸는 투자전략",
    "염블리 염승환과 함께라면 주식이 쉽고 재미있다",
    "주문하신 꿈은 매진입니다",
...
book_summary = [
    """1〈바람과 함께사라지다〉만큼 미국인들, 세계인들, 그리고 한국인들에게 사랑받아 온 이야기가 있을까요? 그런 소설이나 그런 영화는 몇 있을지 몰라도, 둘 다는 있을 수 없지요. 〈바람과 함께 사라지다〉는 주인공 스칼렛의 뛰어남을 그대로 갖추었습니다. 스칼렛처럼 반짝반짝 빛나고, 거침이 없고, 삶에 대한 열정으로 가득하죠. 그리고 무엇보다, 사건들을 ‘직선적이며 단순하게’ 바라보는 태도가 스칼렛 오하라와 꼭 닮았습니다.
...
profile_images = [
    ...
    "https://images.unsplash.com/photo-1566710770069-4dafb67070aa",
    "https://images.unsplash.com/photo-1561848193-9bd53d8de171",
    "https://images.unsplash.com/photo-1531427186611-ecfd6d936c79",
    "https://images.unsplash.com/photo-1579783902614-a3fb3927b6a5",
    "https://images.unsplash.com/photo-1455274111113-575d080ce8cd",
...
library_images = [
    "https://images.unsplash.com/photo-1507842217343-583bb7270b66?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1453&q=80",
]
